...
\begin{minipage}{\textwidth}
	...
	\end{minipage}
	\begin{minipage}{0.5\linewidth}
		\includegraphics[width=\linewidth]{images/plots/plot_speed_individual_160}
	\end{minipage}
	\captionof{figure}{Fartprofiler for testdeltager 45,77,113 og 160's opgave 20,23,8 og 20. Den tilbagelagte distance ud af $x$-aksen og farten ud af $y$-aksen}
	\label{fig:kvaliativ_persons_3}
\end{minipage}
...
\begin{minipage}{\textwidth}
	...
	\end{minipage}
	\begin{minipage}{0.5\linewidth}
		\includegraphics[width=\linewidth]{images/plots/plot_speed_time_individual_160}
	\end{minipage}
	\captionof{figure}{Fartprofiler for testdeltager 45,77,113 og 160's opgave 20,23,8 og 20. Den forløbne tid ud af $x$-aksen og farten ud af $y$-aksen}
	\label{fig:kvaliativ_persons_3}
\end{minipage}
