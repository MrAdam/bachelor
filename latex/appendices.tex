...
\begin{minipage}{\textwidth}
\centering
\includegraphics[height=.2\textheight,width=0.4\textwidth]{images/plots/plot_testdeltager_1}
\captionof{figure}{Testdeltager 1}
\label{fig:testdeltager1}
\includegraphics[width=.25\textheight,width=0.4\textwidth]{images/plots/plot_testdeltager_6}
\captionof{figure}{Testdeltager 6}
\label{fig:testdeltager6}
\includegraphics[width=.25\textheight,width=0.4\textwidth]{images/plots/plot_testdeltager_10}
