...
% Diskussion af AIC
Analysen af pegeopgaver viste, ligesom analysen af tunnelopgaverne, at Meyer's formulering tilpassede vores indsamlede data bedst, da den havde AIC-værdi på 92728.38 for alle personers pegeopgaver. Dette var 34.64 mindre end MacKenzie's formulering, som derved er den næstbedste formulering. Herefter fulgte Fitts' formulering som var 75,79 større end Meyer's formulering. Den formulering som tilpassede vores data dårligst var Welford, da den havde den højeste AIC-værdi og var 1781,96 større end Meyer's formulering. For at kunne sige at to modeller tilpasser den indsamlede data lige godt, så skal forskellen mellem dem være under to\cite{burnham2004}. Hvis de måske tilpasser den indsamlede data lige godt, så skal forskellen mellem dem være mellem fire og syv\cite{burnham2004}. Hvis de ikke tilpasser dataen lige godt, så vil forskellen ligge over 10\cite{burnham2004}. Forskellene mellem Meyer's formulering og de tre andre er alle større end 10. Vi kan derfor sige at Meyer's er den formulering som tilpasser vores data bedst, da den har den mindste AIC-værdi.

Vi valgte også at lave AIC analyse af alle opgaver for 10 tilfældige personer. Her var resultaterne mere varierede, men Meyer's formulering havde den laveste ved syv ud af 10 testdeltagere. MacKenzie's formulering havde den laveste ved to ud af 10 testdeltagere, mens Welford's formulering havde den laveste værdi ved en af testdeltagerne. Der var en generel tendens til at forskellene mellem Meyer's formulering, MacKenzie's formulering og Fitts' formulering lå under to, hvilket betyder at de tilpasser dataen for enkeltpersoner lige godt. Welford's var lidt mere blandet. Her var en af forskellene under to, seks var mellem to og 10 og to var over 10. Det tyder altså på at Welford's formulering på enkeltpersonerne måske tilpasser dataen lige så godt som de fire andre, men at vi ikke kan være sikre på dette.\\

For at understøtte vores AIC analyse lavede vi også en analyse af residualplot. På residualplottene var det tydeligt at se at Meyer's formulering var den som tilpassede den indsamlede data bedst, da dens smoothing grafen generelt var nærmest nul-linjen og dens residualer lå mest tilfældigt omkring nul-linjen. MacKenzie's og Fitts' formulering lignede hinanden rigtig meget og vi kan derfor ikke se hvilken af dem som ville være næst- og tredjebedst. Det er dog klart udfra residualplottene, at Welfold's formulering er den som tilpasser dataen dårligst, da smoothing grafen ligger længere fra nul-linjen og residualplottene ikke ligger tilfældigt omkring nul-linjen. Residualplottene følger altså vores AIC-analyse, idet at Meyer's formulering er den bedst og Welford's er den dårligste. Det er dog svært at sige om Fitts' og MacKenzie's formulering ligger tæt nok på Meyer's til at de tilpasser dataen lige så godt, hvilket vores AIC-analyse til gengæld klart kunne svare på at de ikke gjorde for alle deltagere.\\
