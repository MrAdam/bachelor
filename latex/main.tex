...
Den kvalitative analyse bygger på 20 tilfældigt udvalgte crowdsourcingdeltagere. For at beskrive lave analysen har vi plottede deltagernes bevægelsesbaner for alle deres pegeopgaver. Et eksempel på et plot ses i figur \ref{fig:movement_random_person}, mens alle 20 plots kan ses i bilag \ref{sec:movementlines}. Bevægelsesbaner med høj $ID$ er mørkeblå, mens bevægelsesbaner med lav $ID$ er lyseblå.

Vi ser en tendens til at testdeltagerne bruger en hovedunderbevægelse til at kommer hen mod målet, efterfulgt af en eller flere korrigerende underbevægelser for at ramme målet. Der er en tendens til at bevægelser med højere $ID$ vil have flere korrigerende underbevægelser end bevægelser med lavere $ID$. Nogle testdeltagere ser ud til første at føre markøren i en forkert retning og så derefter fører makøren mod målet. Enkelte deltagere har også enkelte opgaver, hvor de kun har en underbevægelse og ingen korrigerende bevægelser. Disse to observationer skal dog ikke ses som en generel tendens.

Udfra de førnævnte tendenser kan vi opstille to hypoteser. Den første hypotese er at testdeltagerne bruger en primær underbevægelse til at bevæge markøren mod målet og en eller flere korrigerende underbevægelser for at ramme målet. Den anden hypotese er at en opgave med højere $ID$ vil resultere i flere korrigerende underbevægelser.  
