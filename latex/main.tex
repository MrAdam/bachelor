...
\addcontentsline{toc}{subsection}{Analyse af Fitt's model}
...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{Fitt's QQ-plot}
	\label{fig:plot_qq_fitt}
\end{minipage}

\addcontentsline{toc}{subsection}{Analyse af Welford's model}
\subsection*{Analyse af Welford's model}
\begin{minipage}{.5\textwidth}
	\centering
...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{Welford's QQ-plot}
	\label{fig:plot_qq_welford}
\end{minipage}

\addcontentsline{toc}{subsection}{Analyse af MacKenzie's model}
\subsection*{Analyse af MacKenzie's model}
\begin{minipage}{.5\textwidth}
	\centering
...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{MacKenzie's QQ-plot}
	\label{fig:plot_qq_mackenzie}
\end{minipage}

\addcontentsline{toc}{subsection}{Analyse af Meyer's model}
\subsection*{Analyse af Meyer's model}
\begin{minipage}{.5\textwidth}
	\centering
...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{Meyer's QQ-plot}
	\label{fig:plot_qq_meyer}
\end{minipage}

\newpage
\addcontentsline{toc}{subsection}{Sammenligning af modellerne}
...
\begin{minipage}{\textwidth}
	...
	\captionof{figure}{Standard residualer vs fitted}
	\label{fig:plot_qq_meyer}
\end{minipage}
\end{landscape}
