...
Når man ser på AIC-værdier, så er det den relative forskel i mellem værdierne for hver model som er vigtig. Vi kan bruge $\Delta_i$, som beskrivelse af forskellen mellem en models AIC-værdier og den mindste AIC-værdi,
\begin{align} 
\Delta_i = AIC_i - AIC_{min}
\end{align}
$\Delta$-værdierne vil derved være den information vi vil midste, ved at bruge en model fremfor en anden\cite{burnham2004}. Modeller med $\Delta_i \leq 2$ vi ikke kunne skælnes mellem, mens modeller med $\Delta_i > 10$ kan siges at være dårligere. Modeller med $4 \leq \Delta_i \leq 7$ kan ikke udelades, men kan heller ikke erstatte minimumsmodellen fuldt\cite{burnham2004}.\\
