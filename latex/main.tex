...
Vi har derfor fjernet alle datapunkter, som afviger med mere end 3 gange standardafvigelsen, $\sigma$, som er kvadratroden af variansen på datasættet \cite{pearson1894}. Ved at filtrere data fra med for stor afvigelse, kan vi fitte en model der beskriver størstedelen af vores data bedre. Figur \ref{fig:testdeltager7unfilter} og \ref{fig:testdeltager7filter} viser den tilpassede affine model for testdeltager 7 med og uden filtreret data.\\\\
\begin{minipage}{\linewidth}
	\begin{minipage}[b]{.45\linewidth}
