...
\begin{minipage}{\linewidth}
	\begin{minipage}[b]{.45\linewidth}
		...
		\captionof{figure}{Accot og Zhai's formulering tilpasset til testperson 7's fire tunnelopgaver, med $ID$ på $x$-aksen og tiden $T$ på $y$-aksen}
	...
	\begin{minipage}[b]{0.45\linewidth}
		...
		\captionof{figure}{Accot og Zhai's formulering tilpasset til testperson 9's fire tunnelopgaver, med $ID$ på $x$-aksen og tiden $T$ på $y$-aksen}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[t]{.45\linewidth}
		...
		\captionof{figure}{Welford's lineære model tilpasset til gennemsnitstiden pr. $ID$ for de 264 testdeltageres tunnelopgave. $ID$ på $x$-aksen og tiden $T$ på $y$-aksen}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[t]{.45\linewidth}
		...
		\captionof{figure}{Welford's lineære model til gennemsnitstiden pr. $ID$, med $ID$ på $x$-aksen og tiden $T$ på $y$-aksen}
