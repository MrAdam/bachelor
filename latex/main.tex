...
\newpage
På baggrund af de affine linjers overenstemmelse med størstedelen af datapunkterne fra det kontrollerede eksperiment har vi konkluderet, at det tilsvarende vil gøre sig gældende for vores ukontrollerede data, og derved godt kan danne grundlag for en analyse af de fire formuleringer af Fitts' lov. Vi vil dog analysere datasættet af to omgange, med og uden filtrerede data. Da forskellen kan have en hvis betydning på de fire formuleringers tilpasning til datasættet.
