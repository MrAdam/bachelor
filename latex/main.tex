...
\begin{minipage}{\linewidth}
	\begin{minipage}[t]{.45\linewidth}
		...
		\captionof{figure}{Welford's affine model til gennemsnitstiden pr. $ID$, men $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
	...
	\begin{minipage}[t]{0.45\linewidth}
		...
		\captionof{figure}{Fitts' affine model til gennemsnitstiden pr. $ID$, men $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[t]{.45\linewidth}
		...
		\captionof{figure}{Meyer's affine model til gennemsnitstiden pr. $ID$, men $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
	...
	\begin{minipage}[t]{0.45\linewidth}
		...
		\captionof{figure}{Mackenzie's affine model til gennemsnitstiden pr. $ID$, men $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[t]{\linewidth}
		...
		\captionof{figure}{Accot \& Zhai's affine model til gennemsnitstiden pr. $ID$, men $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
...
De to spiralmodeller er lavet på baggrund af Accot og Zhai's spiral og ses i figur.
\begin{align*}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[b]{.45\linewidth}
		...
		\captionof{figure}{Accot og Zhai's formulering tilpasset til testperson 2, med $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
	...
	\begin{minipage}[b]{0.45\linewidth}
		...
		\captionof{figure}{Accot og Zhai's formulering tilpasset til testperson 10, med $ID$ på $x$-aksen og tiden $T$ på $y$-aksen.}
...
\chapter*{Diskussion}
Vi vil i dette afsnit forsøge at diskutere vores fremgangsmåde og resultater fra både vores forsøgsopstilling og analyse.
...
\addcontentsline{toc}{section}{Forsøgsopstilling}
\section*{Forsøgsopstilling}
Vores valg af opslagssteder i det ukontrollerede forsøg kan have haft en indflydelse på den indsamlede data. Vi valgte at bruge Reddit, hvilket giver os en meget specifik målgruppe, da den typiske Reddit-bruger er .......! Dette er også udslagsgivende i vores indsamlede data, hvor gennemsnitsalderen er 24.5 år og 233 ud af 257 er mænd. Det er påvist af \cite{looser2005} at det ikke gør en stor forskel at deltagere bruger meget tid på videospil. Derfor burde det ikke have nogen nævneværdi indflydelse på vores forsøg, at $22\%$ af vores testdeltagere angav at de spillede videospil mellem 15 og 40 timer om ugen.
