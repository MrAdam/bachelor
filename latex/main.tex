...
Den relative forskel mellem modellerne beskriver vi ved $\Delta_i$, hvilket er beregnet som forskellen i mellem AIC værdien for den $i$'te model og AIC værdien for modellen med den mindste AIC værdi, se (\ref{eq:delta_aic}). Denne måde at beregne de relative forskelle er foreslået i \cite{burnham2004}.
\begin{align}
