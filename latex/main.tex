...
Den kvalitative analyse baserer sig på 22 tilfældigt udvalgte crowdsourcingdeltagere. Vi har plottet testdeltagernes bevægelsesbaner for alle deres pegeopgaver, hvilket gør det muligt at se sammenhænge i mellem testdeltagerne. Figur \ref{fig:movement_random_person_1} og \ref{fig:movement_random_person_2} viser hver ét eksempel, på en testdeltagers bevægelsesbaner. De resterende 20 plots kan ses i bilag \ref{sec:movementlines}. Bevægelsesbaner med et højt $ID$ er mørkeblå, i mens bevægelsesbaner med et lavt $ID$ er lyseblå.

Vi ser en tendens til, at testdeltagerne bruger én primær underbevægelse for at komme hen mod målet, efterfulgt af én eller flere korrigerende mindre underbevægelser for at ramme målet. Der er en tendens til, at bevægelser i opgaver med højere $ID$ vil have flere korrigerende underbevægelser end bevægelser i opgaver med lavere $ID$. Nogle testdeltagere ser ud til først at føre markøren i en forkert retning og så derefter føre markøren mod målet. Enkelte deltagere har også nogen få opgaver, hvor de kun har én primær underbevægelse uden nogen efterfølgende korrigerende bevægelser. Disse to observationer skal dog ikke ses som en generel tendens.
...
\begin{minipage}{\linewidth}
	...
	\begin{minipage}{.45\linewidth}
		\centering
		\includegraphics[width=\linewidth]{images/plots/plot_analysis_qualitative_2}
