...
I forhold til vores konstanter $a$ og $b$ og Accot og Zhai's, så er der igen en væsentlig forskel. De fandt frem til $a=115$ og $b=169$, imens vores værdier er på $a=2097.09$ og $b=553.25$. Det er svært at diskutere i yderlighed, hvad denne forskel betyder, da vi kun har brugt 4 spiralopgaver imens de brugte 16, og endvidere har vi heller ikke brugt den samme værdi, $w$, for bredden af spiraltunnellerne, dette skyldes, at vi ikke fik vores programmel til at tegne spiraller ved hjælp af polære koordinater ligesom Accot og Zhai har gjort det.
