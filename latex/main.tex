...
På grund af den store variation i forskellene vil vi vælge AIC-værdierne for det fulde datasæt at konkludere ud fra. Dette er primært begrundet med, at der findes en version, AIC$_c$, til at beregne AIC-værdier for datasæt, hvor antallet af datapunkter, $n$, er tilpas lille. Burnham argumenter i \cite{burnham2004} for, at hvis $\frac{n}{K} <\approx 40$ så bør AIC$_c$ bruges i stedet for $AIC$, i vores tilfælde har vi $n=4$ og $K=2 \vee 1$, hvilket giver værdier markant mindre end 40, og vi burde derfor have brugt AIC$_c$ i stedet for AIC.
