...
\begin{figure}[h]
\centering
\includegraphics[width=.5\linewidth]{images/illustrations/fitt_ex1}
...
\begin{figure}[h]
\centering
\includegraphics[width=.5\linewidth]{images/illustrations/fitt_ex2}
...
\begin{figure}[h]
\centering
\includegraphics[width=.5\linewidth]{images/illustrations/fitt_ex3}
...
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=.4\linewidth]{images/plots/plot_residual_fitt}
	\captionof{figure}{Fitt's residualplot}
	\label{fig:plot_residual_fitt}
	
	\includegraphics[width=.4\linewidth]{images/plots/plot_residual_welford}
	\captionof{figure}{Welford's residualplot}
	\label{fig:plot_residual_welford}
	
	\includegraphics[width=.4\linewidth]{images/plots/plot_residual_mackenzie}
	\captionof{figure}{MacKenzie's residualplot}
	\label{fig:plot_residual_mackenzie}
	
	\includegraphics[width=.4\linewidth]{images/plots/plot_residual_meyer}
