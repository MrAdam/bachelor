...
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{images/illustrations/meyer_plot_comparison}
...
På trods af at de fire formuleringer er forskellige, så vil de godt kunne approksimere hinanden. Vi har derfor plottet de fire formulering i to interval, for at se om de approksimere hinanden.
...
\includegraphics[width=\textwidth, trim = 7cm 22cm 20cm 5cm, clip]{images/screenshots/ex_step_6_pointing_path}
