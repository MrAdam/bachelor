...
\section*{Analyse af tunnelopgaver}

\addcontentsline{toc}{subsection}{Analyse af spiralopgaver}
\section*{Analyse af spiralopgaver}
...
\begin{figure}[h]
\centering
\includegraphics[width=.5\linewidth, trim = 0cm 0cm 7cm 0cm, clip]{images/plots/kvalitativ_analyse}
\caption{Bevægelsesbaner for en tilfældig testdeltager.}
