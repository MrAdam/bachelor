...
Når vi kigger på de fire formuleringer, så kan vi vise, at de ikke er ens, ved at vælge et fast $A = 5$ og $W = 1$ og finde ét punkt, hvor de to funktionsværdier er forskellige.
\begin{align*}
\text{Fitts: } &T=a+b\cdot\log\left(\frac{2\cdot5}{2}\right)\\
\text{Welford: } &T=k\cdot\log\left(\frac{5+0.5\cdot 2}{2}\right)\\
\text{Mackenzie: } &T=a+b\cdot\log\left(\frac{5 + 2}{2}\right)\\
\text{Meyer: } &T=a+b\cdot\sqrt{\frac{5}{2}}
\end{align*}
Ved at sætte $a=0$ kan vi finde skæringen med $y$-aksen og vise deres forskellige funktionsværdier.
\begin{align*}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[b]{.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_tunnel_model_welford}
		\captionof{figure}{Welford's affine model}
		\label{fig:welford_tunnel_line}
	\end{minipage}
	\begin{minipage}[b]{0.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_tunnel_model_fitt}
		\captionof{figure}{Fitts' affine model}
		\label{fig:fitt_tunnel_line}
	\end{minipage}
	\begin{minipage}[b]{.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_tunnel_model_meyer}
		\captionof{figure}{Meyer's affine model}
		\label{fig:meyer_tunnel_line}
	\end{minipage}
	\begin{minipage}[b]{0.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_tunnel_model_mackenzie}
		\captionof{figure}{Mackenzie's affine model}
		\label{fig:mackenzie_tunnel_line}
	\end{minipage}
	\begin{minipage}[b]{\linewidth}
		\centering
		\includegraphics[width=0.5\textwidth]{images/plots/plot_tunnel_model_accot}
...
\begin{minipage}{\linewidth}
	\begin{minipage}[b]{.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_spiral_model_without}
		\captionof{figure}{Spiral model without additive}
		\label{fig:spiral_model_without}
	\end{minipage}
	\begin{minipage}[b]{0.50\linewidth}
		\includegraphics[width=\textwidth]{images/plots/plot_spiral_model_with}
