...
\end{minipage}\\\\
Udfra AIC-analysen har vi mulighed for at vurdere præcisionen af de fire modeller. Det ses af figur \ref{fig:plot_analysis_aic} at AIC-tallet Meyer-modellen er lavest, men både MacKenzies og Fitts ligger kort efter. Til gengæld ligger Welford-modellen langt højere end de tre andre. I følge AIC-analysen er Meyer-modellen altså den bedste, mens Welford-modellen er den klart dårligste. MacKenzie- og Fitt-modellerne ligger tæt på hinanden og ligger også tæt på Meyers.
