...
%Vi har lavet hastighedsprofiler for testdeltagere, indtilvidere kun én enkelt opgave af gangen \ref{fig:plot_velocity_random} og kun i forhold til den reelle retning, dvs. vi mangler stadig hastighedsprofiler imod målet.
...
Vores testdata kom ikke kun fra Reddit, men også fra opslag på vores Facebook-væg. Dette indfører også et bias som kan være væsentligt, da det er vores familie og venner vi derved bruger. Familie og venner har ofte hørt om projektet før og kan derfor have en forventning om hvad der skal ske og hvad de burde gøre. Da både Reddit og Facebook hovedsageligt bruges af yngre personer, så vil vores målgruppe også være begrænset heraf. Vi har f.eks. kun ni testpersoner som er ældre end 40. 


Ukontrolleret forsøg
Mus vs andre devices
Fjernelse af standardafvigelser
Bias
...
Vores data har vist at tre af de fire modeller for Fitts' Lov er meget ens. 
Hvor udbredte er de fire formler
Sammenligne med Accot og Sheik
Sammenligne med Two Large Datasets
Er a og b realistiske
Error rate
AIC
Residualplots
