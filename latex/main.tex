...
\begin{minipage}{\linewidth}
	\begin{minipage}{.5\linewidth}
		...
		\captionof{figure}{Fitt's residualplot}
...
\end{tabular}
\caption{AIC værdier og indbyrdes forskel med udgangspunkt i Welfords som nulpunkt}
\label{tab:table_analysis_aic}
\end{table}
...
De to spiralmodeller er lavet på baggrund af Accot og Zhai's spiral og ses i figur \ref{fig:spiral_model_without} og \ref{spiral_model_with}.
\begin{align*}
