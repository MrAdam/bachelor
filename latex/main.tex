...
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[height=.2\textheight]{images/plots/plot_residual_fitt}
	\captionof{figure}{Fitt's residualplot}
	\label{fig:plot_residual_fitt}
	
	\includegraphics[height=.2\textheight]{images/plots/plot_residual_welford}
	\captionof{figure}{Welford's residualplot}
	\label{fig:plot_residual_welford}
	
	\includegraphics[height=.2\textheight]{images/plots/plot_residual_mackenzie}
	\captionof{figure}{MacKenzie's residualplot}
	\label{fig:plot_residual_mackenzie}
	
	\includegraphics[height=.2\textheight]{images/plots/plot_residual_meyer}
